        ...
        return (
          ...
          >
            <div className="flex flex-col md:flex-row gap-10 justify-center h-[600px] my-20 md:my-0 items-center px-4">
              ...
              <div className="w-[550px] h-[550px] rounded-full hover:scale-105 transition-all bg-white p-4 flex items-center justify-center shadow-2xl shadow-red-400 overflow-hidden">
                <img
                  src={item.images[0]}
                  alt={item.title}
